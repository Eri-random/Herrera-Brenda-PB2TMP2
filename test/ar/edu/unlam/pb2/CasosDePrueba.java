...
public class CasosDePrueba {
	...
	public void queSePuedaInstanciarOtroComestible() {
		...
		assertEquals("07/07/2021", ((Carne)producto).getFechaDeElaboracion());
		assertEquals("15/07/2021", ((Carne)producto).getFechaDeVencimiento());
	...
	public void queSePuedanObtenerLosProductosComestibles() {
		...
		Integer esperado = 2;
		Integer obtenido = vital.getProductosComestibles().size();
